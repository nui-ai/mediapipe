...
target_root_import_name = 'hand_tracking_mp_lean'
...
def _write__init__source_file():
    ...
    content_to_write = [
        ...
        '\n',
        f'from {target_root_import_name}.python import *\n',
        f'import {target_root_import_name}.python.solutions as solutions \n',
        f'fimport {target_root_import_name}.tasks.python as tasks\n',
        '\n',
        'del framework\n',
        'del gpu\n',
        'del modules\n',
        'del python\n',
        f'del {target_root_import_name}\n',
        'del util\n',
...
class GeneratePyProtos(build_ext.build_ext):
  ...
  def run(self):
    ...
    # os.makedirs(os.path.abspath(self.build_lib) + '/' + target_root_import_name, exist_ok=True)
...
setuptools.setup(
    ...
    package_dir={target_root_import_name: "mediapipe"},  # makes importable as mediapipe_lean not as mediapipe
    packages=[
        f'{target_root_import_name}',
        f'{target_root_import_name}.python',
        f'{target_root_import_name}.python.solutions'],
    cmdclass={
        'build_py': BuildPy,
