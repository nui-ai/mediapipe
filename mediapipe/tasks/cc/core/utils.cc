...
CalculatorGraphConfig AddFlowLimiterCalculator(
  ...
  auto& options =
      flow_limiter.GetOptions<hand_tracking_mp_lean::FlowLimiterCalculatorOptions>();
...
void FixGraphBackEdges(::hand_tracking_mp_lean::CalculatorGraphConfig& graph_config) {
