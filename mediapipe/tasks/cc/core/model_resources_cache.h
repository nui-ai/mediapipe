...
inline constexpr hand_tracking_mp_lean::GraphService<ModelResourcesCache>
    kModelResourcesCacheService("hand_tracking_mp_lean::tasks::ModelResourcesCacheService");
