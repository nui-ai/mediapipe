...
class ModelTaskGraph : public Subgraph {
 ...
 protected:
  ...
  //   - a tensor vector (std::vector<mediapipe_v01013_based::Tensor>) input stream with tag
  //     "TENSORS", representing the input tensors to be consumed by the
  //     inference engine.
  //   - a tensor vector (std::vector<mediapipe_v01013_based::Tensor>) output stream with tag
