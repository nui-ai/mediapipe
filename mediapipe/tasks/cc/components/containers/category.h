...
// Utility function to convert from hand_tracking_mp_lean::Classification proto to Category
// struct.
Category ConvertToCategory(const hand_tracking_mp_lean::Classification& proto);
