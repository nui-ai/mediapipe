...
struct HolisticHandTrackingOutput {
  std::optional<api2::builder::Stream<hand_tracking_mp_lean::NormalizedLandmarkList>>
      landmarks;
  std::optional<api2::builder::Stream<hand_tracking_mp_lean::LandmarkList>> world_landmarks;

  struct DebugOutput {
    api2::builder::Stream<hand_tracking_mp_lean::NormalizedRect> roi_from_pose;
    api2::builder::Stream<hand_tracking_mp_lean::NormalizedRect> roi_from_recrop;
    api2::builder::Stream<hand_tracking_mp_lean::NormalizedRect> tracking_roi;
  };
...
absl::StatusOr<HolisticHandTrackingOutput> TrackHolisticHand(
    ...
    api2::builder::Stream<hand_tracking_mp_lean::NormalizedLandmarkList> pose_landmarks,
    api2::builder::Stream<hand_tracking_mp_lean::LandmarkList> pose_world_landmarks,
