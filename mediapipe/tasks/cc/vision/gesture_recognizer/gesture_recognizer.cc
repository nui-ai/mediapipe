...
using GestureRecognizerGraphOptionsProto = ::hand_tracking_mp_lean::tasks::vision::
  ...
  return {
      {/* gestures= */ {output_packets[kHandGesturesStreamName]
       ...
       {output_packets[kHandednessStreamName]
            .Get<std::vector<hand_tracking_mp_lean::ClassificationList>>()},
       /* hand_landmarks= */
       ...
       {output_packets[kHandWorldLandmarksStreamName]
            .Get<std::vector<hand_tracking_mp_lean::LandmarkList>>()}},
  };
}
