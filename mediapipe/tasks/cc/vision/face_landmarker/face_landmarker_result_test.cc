...
TEST(FaceLandmarkerResultTest, Succeeds) {
  hand_tracking_mp_lean::NormalizedLandmarkList face_landmarks_proto;
  ...
  hand_tracking_mp_lean::ClassificationList face_blendshapes_proto;
  ...
  hand_tracking_mp_lean::MatrixData matrix_proto;
