...
using AudioClassifierResult =
    ::hand_tracking_mp_lean::tasks::components::containers::ClassificationResult;
...
class AudioClassifier : tasks::audio::core::BaseAudioTaskApi {
 public:
  ...
  absl::StatusOr<std::vector<AudioClassifierResult>> Classify(
      hand_tracking_mp_lean::Matrix audio_clip, double audio_sample_rate);
  ...
  absl::Status ClassifyAsync(hand_tracking_mp_lean::Matrix audio_block,
