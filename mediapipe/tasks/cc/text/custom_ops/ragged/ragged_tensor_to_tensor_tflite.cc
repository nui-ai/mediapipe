...
bool ValidateDefaultValueShape(TfLiteContext* context,
  ...
  // TFLite.
  // TODO: Only scalar default value sizes are supported.
...
void* Initialize(TfLiteContext* context, const char* buffer, size_t length) {
  ...
  // TODO : Converting flat buffer to a vector of strings looks not very
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
  ...
  // TODO : Only scallar default value is supported.
