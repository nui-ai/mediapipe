...
//   hand_tracking_mp_lean::Detection. In the input Detection, the score field is required,
 ...
 public:
  ...
  absl::Status VerifySequence() {
    ...
    if (all_present) {
      ...
      return ::hand_tracking_mp_lean::NotFoundErrorBuilder(MEDIAPIPE_LOC) << error_msg;
    }
  }
