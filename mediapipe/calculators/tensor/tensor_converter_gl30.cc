 ...
 public:
  ...
  absl::Status InitTensorConverterProgramGl30(
    ...
    hand_tracking_mp_lean::GlhCreateProgram(
        hand_tracking_mp_lean::kBasicVertexShader, shader_source.c_str(), NUM_ATTRIBUTES,
  ...
  Tensor Convert(const GpuBuffer& input) override {
    ...
    glVertexAttribPointer(ATTRIB_VERTEX, 2, GL_FLOAT, 0, 0,
                          hand_tracking_mp_lean::kBasicSquareVertices);
    glEnableVertexAttribArray(ATTRIB_VERTEX);
    glVertexAttribPointer(ATTRIB_TEXTURE_POSITION, 2, GL_FLOAT, 0, 0,
                          hand_tracking_mp_lean::kBasicTextureVertices);
