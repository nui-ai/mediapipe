...
class InferenceOnDiskCacheHelper {
 public:
  absl::Status Init(const mediapipe_v01013_based::InferenceCalculatorOptions& options,
 ...
 private:
  ...
  mediapipe_v01013_based::InferenceCalculatorOptions::Delegate::Gpu::CacheWritingBehavior
