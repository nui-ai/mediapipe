...
class LandmarksSmoothingCalculator : public NodeIntf {
 public:
  static constexpr Input<hand_tracking_mp_lean::NormalizedLandmarkList>::Optional
      kInNormLandmarks{"NORM_LANDMARKS"};
  static constexpr Input<hand_tracking_mp_lean::LandmarkList>::Optional kInLandmarks{
      "LANDMARKS"};
  ...
  static constexpr Input<OneOf<NormalizedRect, Rect>>::Optional kObjectScaleRoi{
      "OBJECT_SCALE_ROI"};
  static constexpr Output<hand_tracking_mp_lean::NormalizedLandmarkList>::Optional
      kOutNormLandmarks{"NORM_FILTERED_LANDMARKS"};
  static constexpr Output<hand_tracking_mp_lean::LandmarkList>::Optional kOutLandmarks{
      "FILTERED_LANDMARKS"};
