...
absl::Status TimedBoxListToRenderDataCalculator::GetContract(
...
absl::Status TimedBoxListToRenderDataCalculator::Open(CalculatorContext* cc) {
...
absl::Status TimedBoxListToRenderDataCalculator::Process(
