...
struct LandmarkProjectionNode : Node<kLandmarkProjectionNodeName> {
  ...
  struct Contract {
    ...
    Repeated<Input<S, hand_tracking_mp_lean::NormalizedLandmarkList>> input_landmarks{
        "NORM_LANDMARKS"};
    ...
    Repeated<Output<S, hand_tracking_mp_lean::NormalizedLandmarkList>> output_landmarks{
        "NORM_LANDMARKS"};

    // Node options.
    Options<S, hand_tracking_mp_lean::LandmarkProjectionCalculatorOptions> options;
