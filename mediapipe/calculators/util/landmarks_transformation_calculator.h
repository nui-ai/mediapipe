...
class LandmarksTransformationCalculator : public NodeIntf {
 public:
  ...
  static constexpr Input<
      hand_tracking_mp_lean::LandmarksTransformationCalculatorOptions>::Optional kInOptions{
      "OPTIONS"};
  static constexpr Output<hand_tracking_mp_lean::LandmarkList> kOutLandmarks{"LANDMARKS"};
