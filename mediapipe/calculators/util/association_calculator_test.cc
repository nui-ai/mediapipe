...
::hand_tracking_mp_lean::Detection DetectionWithRelativeLocationData(double xmin,
                                                         double ymin,
                                                         double width,
                                                         double height) {
  ::hand_tracking_mp_lean::Detection detection;
  ::hand_tracking_mp_lean::LocationData* location_data = detection.mutable_location_data();
  location_data->set_format(::hand_tracking_mp_lean::LocationData::RELATIVE_BOUNDING_BOX);
...
class AssociationDetectionCalculatorTest : public ::testing::Test {
 protected:
  ...
  ::hand_tracking_mp_lean::Detection det_0, det_1, det_2, det_3, det_4, det_5;
};
...
TEST_F(AssociationDetectionCalculatorTest, DetectionAssocTest) {
  ...
  auto input_vec_0 = absl::make_unique<std::vector<::hand_tracking_mp_lean::Detection>>();
  ...
  auto input_vec_1 = absl::make_unique<std::vector<::hand_tracking_mp_lean::Detection>>();
  ...
  auto input_vec_2 = absl::make_unique<std::vector<::hand_tracking_mp_lean::Detection>>();
  ...
  const auto& assoc_rects =
      output[0].Get<std::vector<::hand_tracking_mp_lean::Detection>>();
...
TEST_F(AssociationNormRectCalculatorTest, NormRectAssocTest) {
  ...
  auto input_vec_0 =
      absl::make_unique<std::vector<::hand_tracking_mp_lean::NormalizedRect>>();
  ...
  EXPECT_EQ(1, output.size());
  const auto& assoc_rects =
      output[0].Get<std::vector<::hand_tracking_mp_lean::NormalizedRect>>();
