...
void RunGraph(const std::string& graph_config_proto,
  ...
  CalculatorGraphConfig config =
      hand_tracking_mp_lean::ParseTextProtoOrDie<CalculatorGraphConfig>(graph_config_proto);
...
class PassThroughAndTsBoundUpdateNode : public hand_tracking_mp_lean::api2::Node {
 public:
  static constexpr hand_tracking_mp_lean::api2::Input<int> kInValue{"VALUE"};
  static constexpr hand_tracking_mp_lean::api2::Output<int> kOutValue{"VALUE"};
  static constexpr hand_tracking_mp_lean::api2::Output<int> kOutTsBoundUpdate{
      "TS_BOUND_UPDATE"};
...
class ToOptionalNode : public hand_tracking_mp_lean::api2::Node {
 public:
  static constexpr hand_tracking_mp_lean::api2::Input<int> kTick{"TICK"};
  static constexpr hand_tracking_mp_lean::api2::Input<int> kInValue{"VALUE"};
  static constexpr hand_tracking_mp_lean::api2::Output<absl::optional<int>> kOutValue{
      "OUTPUT"};
