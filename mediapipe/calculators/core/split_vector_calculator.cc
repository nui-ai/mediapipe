...
typedef SplitVectorCalculator<hand_tracking_mp_lean::NormalizedLandmark, false>
    SplitLandmarkVectorCalculator;
REGISTER_CALCULATOR(SplitLandmarkVectorCalculator);

typedef SplitVectorCalculator<hand_tracking_mp_lean::NormalizedLandmarkList, false>
    SplitNormalizedLandmarkListVectorCalculator;
REGISTER_CALCULATOR(SplitNormalizedLandmarkListVectorCalculator);

typedef SplitVectorCalculator<hand_tracking_mp_lean::NormalizedRect, false>
...
typedef SplitVectorCalculator<hand_tracking_mp_lean::Detection, false>
    SplitDetectionVectorCalculator;
REGISTER_CALCULATOR(SplitDetectionVectorCalculator);

typedef SplitVectorCalculator<hand_tracking_mp_lean::ClassificationList, false>
...
typedef SplitVectorCalculator<hand_tracking_mp_lean::Image, false>
    SplitImageVectorCalculator;
REGISTER_CALCULATOR(SplitImageVectorCalculator);

typedef SplitVectorCalculator<hand_tracking_mp_lean::ImageFrame, true>
