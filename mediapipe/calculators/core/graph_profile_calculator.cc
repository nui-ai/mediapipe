...
// hand_tracking_mp_lean::GraphProfiler::CaptureProfile to the "PROFILE" output stream.
//
...
class GraphProfileCalculator : public Node {
 public:
  ...
  absl::Status Process(CalculatorContext* cc) final {
    auto options = cc->Options<::hand_tracking_mp_lean::GraphProfileCalculatorOptions>();
