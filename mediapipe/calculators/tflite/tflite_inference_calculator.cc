...
int GetXnnpackNumThreads(
    const hand_tracking_mp_lean::TfLiteInferenceCalculatorOptions& opts) {
...
class TfLiteInferenceCalculator : public CalculatorBase {
 ...
 private:
  ...
  hand_tracking_mp_lean::TfLiteInferenceCalculatorOptions::Delegate::Gpu::Api
      tflite_gpu_runner_api_;
  hand_tracking_mp_lean::TfLiteInferenceCalculatorOptions::Delegate::Gpu::InferenceUsage
...
#if MEDIAPIPE_TFLITE_GPU_SUPPORTED
  const auto& options =
      cc->template Options<::hand_tracking_mp_lean::TfLiteInferenceCalculatorOptions>();
...
absl::Status TfLiteInferenceCalculator::GetContract(CalculatorContract* cc) {
  ...
  const auto& options =
      cc->Options<::hand_tracking_mp_lean::TfLiteInferenceCalculatorOptions>();
...
absl::Status TfLiteInferenceCalculator::ReadKernelsFromFile() {
  ...
  if (use_kernel_caching_) {
    ...
    if (hand_tracking_mp_lean::File::Exists(cached_kernel_filename_)) {
...
absl::Status TfLiteInferenceCalculator::InitTFLiteGPURunner(
  ...
  switch (tflite_gpu_runner_usage_) {
    case hand_tracking_mp_lean::TfLiteInferenceCalculatorOptions::Delegate::Gpu::
        FAST_SINGLE_ANSWER: {
  ...
  switch (tflite_gpu_runner_api_) {
    case hand_tracking_mp_lean::TfLiteInferenceCalculatorOptions::Delegate::Gpu::OPENGL: {
      tflite_gpu_runner_->ForceOpenGL();
      break;
    }
    case hand_tracking_mp_lean::TfLiteInferenceCalculatorOptions::Delegate::Gpu::OPENCL: {
      tflite_gpu_runner_->ForceOpenCL();
      break;
    }
    case hand_tracking_mp_lean::TfLiteInferenceCalculatorOptions::Delegate::Gpu::ANY: {
