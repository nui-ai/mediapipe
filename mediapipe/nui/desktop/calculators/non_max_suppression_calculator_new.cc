...
// Example config:
// node {
//   calculator: "NonMaxSuppressionCalculatorNew"
...
//   }
// }
class NonMaxSuppressionCalculatorNew : public CalculatorBase {
 public:
  NonMaxSuppressionCalculatorNew() = default;
  ~NonMaxSuppressionCalculatorNew() override = default;
...
REGISTER_CALCULATOR(NonMaxSuppressionCalculatorNew);
