...
// Usage example:
// node {
//   calculator: "TensorsToClassificationCalculatorNew"
...
//   }
// }
class TensorsToClassificationCalculatorNew : public Node {
 public:
...
MEDIAPIPE_REGISTER_NODE(TensorsToClassificationCalculatorNew);

absl::Status TensorsToClassificationCalculatorNew::Open(CalculatorContext* cc) {
...
absl::Status TensorsToClassificationCalculatorNew::Process(CalculatorContext* cc) {
...
absl::Status TensorsToClassificationCalculatorNew::Close(CalculatorContext* cc) {
  return absl::OkStatus();
}

bool TensorsToClassificationCalculatorNew::IsClassIndexAllowed(int class_index) {
...
TensorsToClassificationCalculatorNew::GetLabelMap(CalculatorContext* cc) {
