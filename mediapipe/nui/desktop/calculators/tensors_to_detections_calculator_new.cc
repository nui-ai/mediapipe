...
// Usage example:
// node {
//   calculator: "TensorsToDetectionsCalculatorNew"
...
//   }
// }
class TensorsToDetectionsCalculatorNew : public Node {
 public:
...
MEDIAPIPE_REGISTER_NODE(TensorsToDetectionsCalculatorNew);

absl::Status TensorsToDetectionsCalculatorNew::UpdateContract(
...
absl::Status TensorsToDetectionsCalculatorNew::Open(CalculatorContext* cc) {
...
absl::Status TensorsToDetectionsCalculatorNew::Process(CalculatorContext* cc) {
...
absl::Status TensorsToDetectionsCalculatorNew::ProcessCPU(
...
absl::Status TensorsToDetectionsCalculatorNew::ProcessGPU(
    CalculatorContext* cc, std::vector<Detection>* output_detections) {
  const auto& input_tensors = *kInTensors(cc);
...
absl::Status TensorsToDetectionsCalculatorNew::Close(CalculatorContext* cc) {
#ifndef MEDIAPIPE_DISABLE_GL_COMPUTE
  if (gpu_inited_) {
...
absl::Status TensorsToDetectionsCalculatorNew::LoadOptions(CalculatorContext* cc) {
...
absl::Status TensorsToDetectionsCalculatorNew::DecodeBoxes(
...
absl::Status TensorsToDetectionsCalculatorNew::ConvertToDetections(
...
Detection TensorsToDetectionsCalculatorNew::ConvertToDetection(
...
absl::Status TensorsToDetectionsCalculatorNew::GpuInit(CalculatorContext* cc) {
...
bool TensorsToDetectionsCalculatorNew::IsClassIndexAllowed(int class_index) {
