...
// Usage example:
// node {
//   calculator: "ThresholdingCalculatorNew"
...
//   }
// }
class ThresholdingCalculatorNew : public CalculatorBase {
 public:
...
REGISTER_CALCULATOR(ThresholdingCalculatorNew);

absl::Status ThresholdingCalculatorNew::GetContract(CalculatorContract* cc) {
...
absl::Status ThresholdingCalculatorNew::Open(CalculatorContext* cc) {
...
absl::Status ThresholdingCalculatorNew::Process(CalculatorContext* cc) {
  if (cc->Inputs().HasTag(kThresholdTag) &&
