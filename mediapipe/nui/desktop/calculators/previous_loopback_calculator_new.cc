...
// PreviousLoopbackCalculatorNew is useful when a graph needs to process an input
...
// Example config:
// node {
//   calculator: "PreviousLoopbackCalculatorNew"
...
// }
class PreviousLoopbackCalculatorNew : public Node {
 public:
...
MEDIAPIPE_REGISTER_NODE(PreviousLoopbackCalculatorNew);
