...
// Example config:
// node {
//   calculator: "RectTransformationCalculatorNew"
...
//   }
// }
class RectTransformationCalculatorNew : public CalculatorBase {
 public:
...
REGISTER_CALCULATOR(RectTransformationCalculatorNew);

absl::Status RectTransformationCalculatorNew::GetContract(CalculatorContract* cc) {
...
absl::Status RectTransformationCalculatorNew::Open(CalculatorContext* cc) {
...
absl::Status RectTransformationCalculatorNew::Process(CalculatorContext* cc) {
...
float RectTransformationCalculatorNew::ComputeNewRotation(float rotation) {
...
void RectTransformationCalculatorNew::TransformRect(Rect* rect) {
...
void RectTransformationCalculatorNew::TransformNormalizedRect(NormalizedRect* rect,
                                                           int image_width,
                                                           int image_height) {
  float width = rect->width();
  float height = rect->height();
