...
#include "mediapipe/nui/desktop/calculators/detections_to_rects_calculator_new.h"
...
absl::Status DetectionsToRectsCalculatorNew::DetectionToRect(
...
absl::Status DetectionsToRectsCalculatorNew::DetectionToNormalizedRect(
    const Detection& detection, const DetectionSpec& detection_spec,
    NormalizedRect* rect) {
  const LocationData location_data = detection.location_data();
  switch (options_.conversion_mode()) {
...
absl::Status DetectionsToRectsCalculatorNew::GetContract(CalculatorContract* cc) {
...
absl::Status DetectionsToRectsCalculatorNew::Open(CalculatorContext* cc) {
...
absl::Status DetectionsToRectsCalculatorNew::Process(CalculatorContext* cc) {
  if (cc->Inputs().HasTag(kDetectionTag) &&
...
absl::Status DetectionsToRectsCalculatorNew::ComputeRotation(
    const Detection& detection, const DetectionSpec& detection_spec,
    float* rotation) {
...
DetectionSpec DetectionsToRectsCalculatorNew::GetDetectionSpec(
...
REGISTER_CALCULATOR(DetectionsToRectsCalculatorNew);
