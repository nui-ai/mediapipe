...
class SingleHandLandmarksDetectorGraph : public core::ModelTaskGraph {
 ...
 private:
  ...
  BuildSingleHandLandmarksDetectorGraph(
    ...
    auto& split_tensors_vector = graph.AddNode("SplitTensorVectorCalculatorNew");
    ...
    auto& tensors_to_landmarks = graph.AddNode("TensorsToLandmarksCalculatorNew");
    ...
    auto& tensors_to_world_landmarks =
        graph.AddNode("TensorsToLandmarksCalculatorNew");
    ConfigureTensorsToLandmarksCalculator(
    ...
    auto& tensors_to_hand_presence = graph.AddNode("TensorsToFloatsCalculatorNew");
    ...
    // hand is present.
    auto& hand_presence_thresholding = graph.AddNode("ThresholdingCalculatorNew");
    ...
    auto& tensors_to_handedness =
        graph.AddNode("TensorsToClassificationCalculatorNew");
    ...
    auto& landmark_letterbox_removal =
        graph.AddNode("LandmarkLetterboxRemovalCalculatorNew");
    ...
    auto& hand_landmarks_to_rect =
        graph.AddNode("HandLandmarksToRectCalculatorNew");
    ...
    auto& hand_rect_transformation =
        graph.AddNode("RectTransformationCalculatorNew");
 ...
 private:
  absl::StatusOr<HandLandmarkerOutputs> BuildHandLandmarksDetectorGraph(
    ...
    auto& begin_loop_multi_hand_rects =
        graph.AddNode("BeginLoopNormalizedRectCalculatorNew");
    ...
    auto& end_loop_handedness =
        graph.AddNode("EndLoopClassificationListCalculatorNew");
    ...
    auto& end_loop_landmarks =
        graph.AddNode("EndLoopNormalizedLandmarkListVectorCalculatorNew");
    ...
    auto& end_loop_world_landmarks =
        graph.AddNode("EndLoopLandmarkListVectorCalculatorNew");
    ...
    auto& end_loop_rects_next_frame =
        graph.AddNode("EndLoopNormalizedRectCalculatorNew");
