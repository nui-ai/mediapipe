...
// Usage example:
// node {
//   calculator: "LandmarkLetterboxRemovalCalculatorNew"
...
// }
class LandmarkLetterboxRemovalCalculatorNew : public CalculatorBase {
 public:
...
REGISTER_CALCULATOR(LandmarkLetterboxRemovalCalculatorNew);
