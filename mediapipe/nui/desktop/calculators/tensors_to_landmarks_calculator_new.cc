...
// Usage example:
// node {
//   calculator: "TensorsToLandmarksCalculatorNew"
...
//   }
// }
class TensorsToLandmarksCalculatorNew : public Node {
 public:
...
MEDIAPIPE_REGISTER_NODE(TensorsToLandmarksCalculatorNew);

absl::Status TensorsToLandmarksCalculatorNew::Open(CalculatorContext* cc) {
...
absl::Status TensorsToLandmarksCalculatorNew::Process(CalculatorContext* cc) {
...
absl::Status TensorsToLandmarksCalculatorNew::LoadOptions(CalculatorContext* cc) {
