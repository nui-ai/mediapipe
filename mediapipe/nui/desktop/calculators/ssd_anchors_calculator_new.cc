...
// Usage example:
// node {
//   calculator: "SsdAnchorsCalculatorNew"
...
//   }
// }
class SsdAnchorsCalculatorNew : public CalculatorBase {
 public:
...
REGISTER_CALCULATOR(SsdAnchorsCalculatorNew);

// Generates grid anchors on the fly corresponding to multiple CNN layers as
// described in:
// "Focal Loss for Dense Object Detection" (https://arxiv.org/abs/1708.02002)
// T.-Y. Lin, P. Goyal, R. Girshick, K. He, P. Dollar
absl::Status SsdAnchorsCalculatorNew::GenerateMultiScaleAnchors(
    std::vector<Anchor>* anchors, const SsdAnchorsCalculatorOptions& options) {
...
absl::Status SsdAnchorsCalculatorNew::GenerateAnchors(
    std::vector<Anchor>* anchors, const SsdAnchorsCalculatorOptions& options) {
  // Verify the options.
