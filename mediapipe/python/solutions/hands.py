...
# the binary protobuf definition of the pipeline is generated by the build from its text (.pb) one,
# e.g. generated at ./build/lib.linux-x86_64-cpython-312/mediapipe/modules/hand_landmark/hand_landmark_tracking_cpu.binarypb.
# the pip install includes it in its environment deployed mediapipe package.
