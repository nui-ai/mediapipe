...
NAME_TO_TYPE: Mapping[str, 'PacketDataType'] = {
    ...
    '::mediapipe_v01013_based::Matrix': PacketDataType.AUDIO,
    '::mediapipe_v01013_based::ImageFrame': PacketDataType.IMAGE_FRAME,
    '::mediapipe_v01013_based::PipelineOutputData': PacketDataType.PROTO, # new proto type introduced while liberating
    '::mediapipe_v01013_based::Classification': PacketDataType.PROTO,
    '::mediapipe_v01013_based::ClassificationList': PacketDataType.PROTO,
    '::mediapipe_v01013_based::ClassificationListCollection': PacketDataType.PROTO,
    '::mediapipe_v01013_based::Detection': PacketDataType.PROTO,
    '::mediapipe_v01013_based::DetectionList': PacketDataType.PROTO,
    '::mediapipe_v01013_based::Landmark': PacketDataType.PROTO,
    '::mediapipe_v01013_based::LandmarkList': PacketDataType.PROTO,
    '::mediapipe_v01013_based::LandmarkListCollection': PacketDataType.PROTO,
    '::mediapipe_v01013_based::NormalizedLandmark': PacketDataType.PROTO,
    '::mediapipe_v01013_based::FrameAnnotation': PacketDataType.PROTO,
    '::mediapipe_v01013_based::TimeSeriesHeader': PacketDataType.PROTO,
    '::mediapipe_v01013_based::Trigger': PacketDataType.PROTO,
    '::mediapipe_v01013_based::Rect': PacketDataType.PROTO,
    '::mediapipe_v01013_based::NormalizedRect': PacketDataType.PROTO,
    '::mediapipe_v01013_based::NormalizedLandmarkList': PacketDataType.PROTO,
    '::mediapipe_v01013_based::NormalizedLandmarkListCollection': PacketDataType.PROTO,
    '::mediapipe_v01013_based::Image': PacketDataType.IMAGE,
    '::std::vector<::mediapipe_v01013_based::Image>': PacketDataType.IMAGE_LIST,
    '::std::vector<::mediapipe_v01013_based::Classification>': PacketDataType.PROTO_LIST,
    '::std::vector<::mediapipe_v01013_based::ClassificationList>': PacketDataType.PROTO_LIST,
    '::std::vector<::mediapipe_v01013_based::Detection>': PacketDataType.PROTO_LIST,
    '::std::vector<::mediapipe_v01013_based::DetectionList>': PacketDataType.PROTO_LIST,
    '::std::vector<::mediapipe_v01013_based::Landmark>': PacketDataType.PROTO_LIST,
    '::std::vector<::mediapipe_v01013_based::LandmarkList>': PacketDataType.PROTO_LIST,
    '::std::vector<::mediapipe_v01013_based::NormalizedLandmark>': PacketDataType.PROTO_LIST,
    '::std::vector<::mediapipe_v01013_based::NormalizedLandmarkList>': (
        PacketDataType.PROTO_LIST
    ),
    '::std::vector<::mediapipe_v01013_based::Rect>': PacketDataType.PROTO_LIST,
    '::std::vector<::mediapipe_v01013_based::NormalizedRect>': PacketDataType.PROTO_LIST,
    '::mediapipe_v01013_based::Joint': PacketDataType.PROTO,
    '::mediapipe_v01013_based::JointList': PacketDataType.PROTO,
    '::std::vector<::mediapipe_v01013_based::JointList>': PacketDataType.PROTO_LIST,
}
