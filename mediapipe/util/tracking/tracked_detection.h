...
class TrackedDetection {
 public:
  ...
  // dimensions.
  TrackedDetection(int unique_id, int64_t timestamp,
                   const ::hand_tracking_mp_lean::NormalizedRect& bounding_box)
      : unique_id_(unique_id),
        initial_timestamp_(timestamp),
        last_updated_timestamp_(timestamp),
        previous_id_(-1) {
  ...
  const ::hand_tracking_mp_lean::NormalizedRect& bounding_box() const {
  ...
  void set_bounding_box(const ::hand_tracking_mp_lean::NormalizedRect& bounding_box) {
 ...
 private:
  ...
  ::hand_tracking_mp_lean::NormalizedRect bounding_box_;
  float left_ = 0.f;
  float right_ = 0.f;
  float top_ = 0.f;
  float bottom_ = 0.f;
