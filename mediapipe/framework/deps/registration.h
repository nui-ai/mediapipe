...
class FunctionRegistry {
 public:
  ...
  std::string GetNormalizedName(absl::string_view name) {
    using ::hand_tracking_mp_lean::registration_internal::kCxxSep;
  ...
  std::string GetQualifiedName(absl::string_view ns,
    ...
    using ::hand_tracking_mp_lean::registration_internal::kCxxSep;
    using ::hand_tracking_mp_lean::registration_internal::kNameSep;
...
#define MEDIAPIPE_REGISTER_FACTORY_FUNCTION_QUALIFIED(RegistryType, var_name, \
                                                      name, ...)              \
  static hand_tracking_mp_lean::RegistrationToken* REGISTRY_STATIC_VAR(var_name,          \
                                                           __LINE__) = []() { \
...
#define MEDIAPIPE_STATIC_REGISTRATOR_TEMPLATE(RegistratorName, RegistryType,  \
  ...
  struct Internal##RegistratorName {                                          \
    static NoDestructor<hand_tracking_mp_lean::RegistrationToken> registration;           \
                                                                              \
    static hand_tracking_mp_lean::RegistrationToken Make() {                              \
      ABSL_RAW_LOG(WARNING, "Registration Dry Run: %s",                       \
                   INTERNAL_MEDIAPIPE_REGISTER_FACTORY_STRINGIFY(             \
  ...
  template <typename T>                                                       \
  NoDestructor<hand_tracking_mp_lean::RegistrationToken>                                  \
...
#define MEDIAPIPE_REGISTER_FACTORY_FUNCTION_QUALIFIED(RegistryType, var_name, \
  ...
  static hand_tracking_mp_lean::RegistrationToken* REGISTRY_STATIC_VAR(var_name,          \
                                                           __LINE__) =        \
      new hand_tracking_mp_lean::RegistrationToken(                                       \
          RegistryType::Register(name, __VA_ARGS__));
