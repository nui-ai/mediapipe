...
// values of a @tensor.
Stream<mediapipe_v01013_based::JointList> ConvertTensorToJointsAtIndex(Stream<Tensor> tensor,
                                                          const int num_joints,
                                                          const int start_index,
                                                          Graph& graph);

// Updates @graph to convert @tensor to a JointList.
inline Stream<::mediapipe_v01013_based::JointList> ConvertTensorToJoints(
