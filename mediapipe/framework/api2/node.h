...
//    public:
//     static constexpr hand_tracking_mp_lean::api2::Input<InputData> kInput{"IN"};
//     static constexpr hand_tracking_mp_lean::api2::Output<OutputData> kOutput{"OUT"};
//
...
class CalculatorBaseFactoryFor<
    T,
    typename std::enable_if<std::is_base_of<hand_tracking_mp_lean::api2::Node, T>{}>::type>
...
MEDIAPIPE_STATIC_REGISTRATOR_TEMPLATE(
    NodeRegistrator, hand_tracking_mp_lean::CalculatorBaseRegistry, T::kCalculatorName,
    std::make_unique<hand_tracking_mp_lean::internal::CalculatorBaseFactoryFor<T>>)

MEDIAPIPE_STATIC_REGISTRATOR_TEMPLATE(SubgraphRegistrator,
                                      hand_tracking_mp_lean::SubgraphRegistry,
...
#define MEDIAPIPE_NODE_CONTRACT(...)                                          \
  static constexpr auto kContract =                                           \
      hand_tracking_mp_lean::api2::internal::MakeContract(__VA_ARGS__);                   \
  using Contract =                                                            \
      typename hand_tracking_mp_lean::api2::internal::TaggedContract<decltype(kContract), \
                                                         kContract>;
...
#define MEDIAPIPE_NODE_IMPLEMENTATION(Impl)                       \
  MEDIAPIPE_REGISTER_FACTORY_FUNCTION_QUALIFIED(                  \
      hand_tracking_mp_lean::CalculatorBaseRegistry, calculator_registration, \
      Impl::kCalculatorName,                                      \
      std::make_unique<hand_tracking_mp_lean::internal::CalculatorBaseFactoryFor<Impl>>)
...
#define MEDIAPIPE_REGISTER_NODE(name)                                    \
  MEDIAPIPE_REGISTER_FACTORY_FUNCTION_QUALIFIED(                         \
      hand_tracking_mp_lean::CalculatorBaseRegistry, calculator_registration, #name, \
      std::make_unique<hand_tracking_mp_lean::internal::CalculatorBaseFactoryFor<name>>)
...
#define MEDIAPIPE_SUBGRAPH_IMPLEMENTATION(Impl)           \
  MEDIAPIPE_REGISTER_FACTORY_FUNCTION_QUALIFIED(          \
      hand_tracking_mp_lean::SubgraphRegistry, subgraph_registration, \
