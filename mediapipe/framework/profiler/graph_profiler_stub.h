...
namespace hand_tracking_mp_lean {
using hand_tracking_mp_lean::CalculatorProfile;
using hand_tracking_mp_lean::GraphProfile;
using hand_tracking_mp_lean::GraphTrace;
...
class GraphProfilerStub {
 public:
  ...
  inline void SetClock(const std::shared_ptr<hand_tracking_mp_lean::Clock>& clock) {}
  ...
  inline void Resume() {}
  inline void Reset() {}
  inline absl::Status Start(hand_tracking_mp_lean::Executor* executor) {
    return absl::OkStatus();
  }
  ...
  const std::shared_ptr<hand_tracking_mp_lean::Clock> GetClock() const { return nullptr; }
};
