...
using ::hand_tracking_mp_lean::proto_ns::internal::WireFormatLite;
...
bool HasField(const FieldPath& field_path, const FieldData& message_data) {
  ...
  return value.ok() &&
         value->value_case() != hand_tracking_mp_lean::FieldData::VALUE_NOT_SET;
}
...
void SetOptionsMessage(
    ...
    proto_ns::RepeatedPtrField<hand_tracking_mp_lean::protobuf::Any>* result) {
