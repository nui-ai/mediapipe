...
struct ABSL_DEPRECATED(
    "Prefer using hand_tracking_mp_lean::tool::TagMap instead, since this structure does "
    "not "
...
ABSL_DEPRECATED(
    "Prefer using hand_tracking_mp_lean::tool::TagMap instead, since this method does not "
