...
class AudioBufferListWrapper {
 public:
  ...
  void InitFromMatrix(const hand_tracking_mp_lean::Matrix& matrix) {
...
- (void)testBufferListToMatrixStereoNonInterleavedFloat {
  ...
  hand_tracking_mp_lean::Matrix inputMatrix(kChannels, kFrames);
  ...
  absl::StatusOr<std::unique_ptr<hand_tracking_mp_lean::Matrix>> matrix =
