...
extern "C" const char* hand_tracking_nui_ai_mediapipe_source_commit() {
  return nui_ai_mediapipe_source_provenance::SourceCommit();
}

extern "C" int hand_tracking_nui_ai_mediapipe_source_dirty() {
  return nui_ai_mediapipe_source_provenance::SourceDirty();
}

extern "C" int
hand_tracking_nui_ai_mediapipe_library_built_by_core_build_rs() {
