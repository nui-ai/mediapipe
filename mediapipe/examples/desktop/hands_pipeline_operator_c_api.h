...
#ifndef MEDIAPIPE_EXAMPLES_DESKTOP_HANDS_PIPELINE_C_API_H_
#define MEDIAPIPE_EXAMPLES_DESKTOP_HANDS_PIPELINE_C_API_H_
...
#endif  // MEDIAPIPE_EXAMPLES_DESKTOP_HANDS_PIPELINE_C_API_H_
